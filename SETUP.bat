...
:: ──────────────────────────────────────────────────────────
:: 5. Создаём ярлык на рабочем столе
:: ──────────────────────────────────────────────────────────
echo.
echo  [5/5] Создаём ярлык на рабочем столе...
...
echo  ║                                                      ║
echo  ║   Запустите программу одним из способов:            ║
echo  ║   • Двойной клик на ярлык "VideoGenerator"          ║
echo  ║     на рабочем столе                                 ║
echo  ║   • Или двойной клик на VideoGenerator.vbs          ║
echo  ║     в папке программы                               ║
echo  ║                                                      ║
echo  ║   После запуска откройте вкладку "Настройки"        ║
echo  ║   и введите ваши API ключи.                         ║
echo  ╚══════════════════════════════════════════════════════╝
echo.
pause
